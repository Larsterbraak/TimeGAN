...
parameters = {'hidden_dim':3, 'num_layers':1, 'iterations':5000,
              'batch_size': 128, 'module_name':'lstm', 'z_dim':4}
...
#e_model, r_model, s_model, g_model, d_model = load_models(1000000) # Load pre-trained models
...
# probs_ester = ester_classifier(load_epochs=1000000)    
